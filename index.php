...
<body>
	<div id="container">
		<div id="header">
			<b>Dikanewsp<i class="fa fa-compass"></i>rtal</b>
...
//taruh skrip 6 halaman index.php
 ...
 echo "<div style='height:500px'></div><hr>"; //ini untuk pembatas antara konten dengna berita populer yg selalu tampil
